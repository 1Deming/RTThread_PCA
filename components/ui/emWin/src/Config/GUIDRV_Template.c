...
**********************************************************************
*/
#define EMWIN_DEBUG_ON

#ifdef EMWIN_DEBUG_ON
#define GUI_DEBUG         rt_kprintf
#else
#define GUI_DEBUG(...)    
#endif 
...
//      //
			...
			//GUI_DEBUG("[enWin]: x,y,PixelIndex:%d,%d,%d\n",x,y,PixelIndex);
      uint8_t dev_pixel = ( uint8_t ) PixelIndex ;
	    //ui_draw_pixel_with_color_at(x, y, PixelIndex);
      display_data_at(x, y, &dev_pixel, 1);
